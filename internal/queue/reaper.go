...
func NewReaper(db *gorm.DB, workers *storage.WorkersRepo, interval, deadAfter time.Duration) *Reaper {
	return &Reaper{db: db, workers: workers, interval: interval, deadAfter: deadAfter}
}
